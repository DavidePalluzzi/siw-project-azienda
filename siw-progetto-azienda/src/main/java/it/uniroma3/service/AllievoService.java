...
public class AllievoService {
	...
	public boolean alreadyExists(Allievo allievo) {
		List<Allievo> allievi = this.repository.findByNomeAndCognomeAndTelefonoAndMailAndLuogoNascitaAndDataNascita(allievo.getNome(), allievo.getCognome(), allievo.getTelefono(),allievo.getMail(),allievo.getLuogoNascita(),allievo.getDataNascita());
		if (allievi.size() > 0)
			return true;
		else 
			return false;
